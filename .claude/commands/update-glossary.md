---
description: 'Update or review the glossary. Run on a doc file to find terms missing from the glossary, or on the glossary itself to check order, cross-links, and best practices.'
---

# Update Glossary

Keep the glossary accurate, complete, and aligned with best practices. Two modes:

- **Mode A:** Run on a doc file to find terms that should be in the glossary but aren't.
...
6. **Product scope.** Include terms specific to the project or used in a special way in docs.
7. **Opening the definition.** Do not repeat the term in the first phrase. Start with the defining content: "A value shorthand that Sindlish stores in memory," not "A variable is..."
...
3. **Scan the doc for product terms.** Flag phrases that look like product or feature terms that might belong in the glossary.
